...
def extract_faces(img):
    ...
    face_points = face_detector.detectMultiScale(gray, 1.3, 2)
    return face_points
    ...
    while ret:
        ...
        if list(extract_faces(frame)) != []:
            ...
            if identified_person: 
                ...
                cv2.putText(frame,'Stranger',(30,30),cv2.FONT_HERSHEY_SIMPLEX,1,(255, 0, 20),2,cv2.LINE_AA)
